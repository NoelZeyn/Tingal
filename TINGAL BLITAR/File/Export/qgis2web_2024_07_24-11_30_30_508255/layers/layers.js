...
var format_Jembatan_18 = new ol.format.GeoJSON();
var features_Jembatan_18 = format_Jembatan_18.readFeatures(json_Jembatan_18, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Jembatan_18 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Jembatan_18.addFeatures(features_Jembatan_18);
var lyr_Jembatan_18 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Jembatan_18, 
                style: style_Jembatan_18,
                popuplayertitle: "Jembatan",
                interactive: false,
                title: '<img src="styles/legend/Jembatan_18.png" /> Jembatan'
            });
...
lyr_OpenStreetMap_0.setVisible(true);lyr_Dusun_1.setVisible(true);lyr_Border_2.setVisible(true);lyr_JalanDesa_3.setVisible(true);lyr_Agri_Kebun_4.setVisible(false);lyr_Agri_Ladang_5.setVisible(false);lyr_Agri_Sawah_6.setVisible(false);lyr_Pemukiman_7.setVisible(false);lyr_Kabel_Listrik_8.setVisible(true);lyr_Kontur_9.setVisible(true);lyr_Relka_10.setVisible(true);lyr_Sungai_11.setVisible(true);lyr_Pemukiman_Warga_12.setVisible(false);lyr_JalanKabupaten_13.setVisible(true);lyr_Toponimi_14.setVisible(true);lyr_Makam_15.setVisible(true);lyr_Bangunan_16.setVisible(true);lyr_Pemerintahan_17.setVisible(true);lyr_Jembatan_18.setVisible(true);lyr_Pendidikan_19.setVisible(true);lyr_Rumah_Sakit_20.setVisible(true);lyr_Sarana_Ibadah_21.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_Dusun_1,lyr_Border_2,lyr_JalanDesa_3,lyr_Agri_Kebun_4,lyr_Agri_Ladang_5,lyr_Agri_Sawah_6,lyr_Pemukiman_7,lyr_Kabel_Listrik_8,lyr_Kontur_9,lyr_Relka_10,lyr_Sungai_11,lyr_Pemukiman_Warga_12,lyr_JalanKabupaten_13,lyr_Toponimi_14,lyr_Makam_15,lyr_Bangunan_16,lyr_Pemerintahan_17,lyr_Jembatan_18,lyr_Pendidikan_19,lyr_Rumah_Sakit_20,lyr_Sarana_Ibadah_21];
...
lyr_Jembatan_18.set('fieldAliases', {'fid': 'fid', 'Nama Jembatan': 'Nama Jembatan', });
...
lyr_Jembatan_18.set('fieldImages', {'fid': 'TextEdit', 'Nama Jembatan': 'TextEdit', });
...
lyr_Jembatan_18.set('fieldLabels', {'fid': 'hidden field', 'Nama Jembatan': 'header label - visible with data', });
